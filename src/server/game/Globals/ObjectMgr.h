...
#define MIN_apocalypse_string_ID           1                    // 'apocalypse_string'
#define MAX_apocalypse_string_ID           2000000000
#define MIN_DB_SCRIPT_STRING_ID        MAX_apocalypse_string_ID // 'db_script_string'
...
class ObjectMgr
{
    ...
    public:
        ...
        bool LoadTrinityStrings() { return LoadTrinityStrings("apocalypse_string", MIN_apocalypse_string_ID, MAX_apocalypse_string_ID); }
