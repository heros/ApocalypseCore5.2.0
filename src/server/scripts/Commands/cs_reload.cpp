...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand reloadCommandTable[] =
        {
            ...
            { "apocalypse_string",            SEC_ADMINISTRATOR, true,  &HandleReloadTrinityStringCommand,              "", NULL },
    ...
    {
        sLog->outInfo(LOG_FILTER_GENERAL, "Re-Loading apocalypse_string Table!");
        sObjectMgr->LoadTrinityStrings();
        handler->SendGlobalGMSysMessage("DB table `apocalypse_string` reloaded.");
        return true;
    }
